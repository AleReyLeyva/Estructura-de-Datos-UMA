...
public class BinTree<T> {
    ...
    //
    // Surname, Name: Rey Leyva, Alejandro
    // Group: Matemáticas + Informática

    public <E> boolean isomorphic(BinTree<E> that) {
        return isomorphicRec(this.root, that.root);
    }
    ...
    private static <A, B> boolean isomorphicRec(Tree<A> t1, Tree<B> t2) {
        if (t1 == null && t2 == null)
            ...
            return isomorphicRec(t1.left, t2.left) && isomorphicRec(t1.right, t2.right);
    }
